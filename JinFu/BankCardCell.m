...
@interface BankCardCell() <UITextFieldDelegate>
{
    BOOL bShowListView;
}
@end
...
- (void)awakeFromNib {
    ...
    UITapGestureRecognizer *hideGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(hideGestureEvent)];
