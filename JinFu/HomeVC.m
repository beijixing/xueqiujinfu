...
//    _bankScrollView.backgroundColor = [UIColor whiteColor];
    ...
    _bankScrollView.frame = CGRectMake(0, 150, MainScreenWidth, MainScreenHeight - 150 - 49 - 64);
}
...
- (void)setNextBilldateCDDays:(UITableViewCell*)cell data:(BankCardListDataModel *)dataModel {
    ...
    NSString *billDateStr = [dataModel.period substringFromIndex:13];
