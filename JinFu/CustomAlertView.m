...
static const CGFloat mHeight = 100;
...
//        
//        // - 标题
//        UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(startX-20, (titleView.frame.size.height - 20) / 2, titleSize.width, 20)];
//        
//        //- 标题太长的话需要处理
...
//    
    ...
    // - 设置消息显示区域
    UIScrollView *msgView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, mHeaderHeight-20, mWidth, (mHeight-mHeaderHeight * 2))];
    ...
    if (self.message && [self.message length]>0)
    {
        ...
        if (messageSize.width > 0)
        {
            ...
            msgLabel.font = [UIFont systemFontOfSize:21.0f];
...
//            otherBtn.backgroundColor = RGBA_COLOR(36, 193, 64, 1);
            [otherBtn setImage:[UIImage imageNamed:@"确定@2x.png"] forState:UIControlStateNormal];
            ...
            [cancelBtn setImage:[UIImage imageNamed:@"取消@2x.png"] forState:UIControlStateNormal];
