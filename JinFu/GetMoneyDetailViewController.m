...
- (void)createView
{
    ...
    //创建button 分类
    NSArray * arrayBtnTitle = @[@"提现日期",@"提现金额"];
    for (int i = 0; i<2; i++) {
        UIButton * buttonTitle = [QGTools createButton:CGRectMake(60+120*i*SCALE, 80, 80*SCALE, 30) bgColor:nil title:arrayBtnTitle[i] titleColor:[UIColor blackColor] tag:101+i action:nil vc:self];
