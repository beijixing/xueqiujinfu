...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.labelGetDate.frame = CGRectMake(40*SCALE, 5, 80*SCALE, 30);
        ...
        self.labelGetNum.frame = CGRectMake(120*SCALE, 5, 100*SCALE, 30);
        ...
        self.labelState.frame = CGRectMake(220*SCALE, 5, 80*SCALE, 30);
